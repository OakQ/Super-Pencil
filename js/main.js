...
function create() {
    ...
    wall1 = walls.create(512, 64, 'spookyAtlas', 'wall'); //create walls where we need them, on the right
    wall2 = walls.create(544, 64, 'spookyAtlas', 'wall');
    wall3 = walls.create(576, 64, 'spookyAtlas', 'wall');
    wall4 = walls.create(608, 64, 'spookyAtlas', 'wall');
